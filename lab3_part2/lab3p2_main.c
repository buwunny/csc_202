...
uint16_t my_asm_16bitset(uint16_t reg_value, uint16_t bitmask);
uint16_t my_asm_16bitclr(uint16_t reg_value, uint16_t bitmask);
uint16_t my_asm_16bitcheck(uint16_t reg_value, uint16_t bitmask);
...
int main(void)
{
  ...
  reg_value = test_reg16;                         // READ operation
  reg_value = my_asm_16bitset(test_reg16, PIE_BIT_MASK);// MODIFY operation  
  test_reg16 = reg_value;                         // WRITE operation
  ...
  reg_value = test_reg16;                         // READ operation
  reg_value = my_asm_16bitset(test_reg16, RD_BIT_MASK);// MODIFY operation  
  test_reg16 = reg_value;                         // WRITE operation
  ...
  reg_value = test_reg16;                         // READ operation
  reg_value = my_asm_16bitset(test_reg16, CRS_BIT_MASK);// MODIFY operation  
  test_reg16 = reg_value;                         // WRITE operation
  ...
  reg_value = test_reg16;                         // READ operation
  reg_value = my_asm_16bitset(
                      test_reg16,
                      (A3_BIT_MASK | A2_BIT_MASK | A1_BIT_MASK |
                       A0_BIT_MASK
                      )
                     );                           // MODIFY operation  
  test_reg16 = reg_value;                         // WRITE operation
  ...
  reg_value = test_reg16;                         // READ operation
  reg_value = my_asm_16bitclr(test_reg16, A2_BIT_MASK); // MODIFY operation  
  test_reg16 = reg_value;                         // WRITE operation
  ...
  reg_value = test_reg16;                         // READ operation
  reg_value = my_asm_16bitclr(test_reg16, CRS_BIT_MASK);  // MODIFY  
  test_reg16 = reg_value;                         // WRITE operation

  reg_value = test_reg16;                         // READ operation
  reg_value = my_asm_16bitset(test_reg16, PRS_BIT_MASK);  // MODIFY  
  test_reg16 = reg_value;                         // WRITE operation
  ...
  else
  {
    ...
    reg_value = my_asm_16bitset(test_reg16, A2_BIT_MASK);   // MODIFY operation  
    test_reg16 = reg_value;                         // WRITE operation
  }
  ...
  if (!my_asm_16bitcheck(reg_value, MD_BIT_MASK))
  {
    ...
    reg_value = my_asm_16bitset(test_reg16, MODE_10_BIT_VALUE);// MODIFY operation  
    test_reg16 = reg_value;                         // WRITE operation

    reg_value = test_reg16;                         // READ operation
    reg_value = my_asm_16bitclr(test_reg16, MODE_01_BIT_VALUE);// MODIFY operation  
    test_reg16 = reg_value;                         // WRITE operation
  }
  else
  {
    ...
    reg_value = my_asm_16bitset(
                        test_reg16,
                        (MODE_10_BIT_VALUE | MODE_01_BIT_VALUE)
                       );                           // MODIFY operation  
    test_reg16 = reg_value;                         // WRITE operation
  }
